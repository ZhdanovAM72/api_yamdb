# Generated by Django 3.2 on 2023-06-16 07:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[reviews.validators.me_validator, django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='Username пользователя')),
                ...
                ('confirmation_code', models.CharField(default='default_code', max_length=255, null=True, verbose_name='код API на почту')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(db_index=True, validators=[django.core.validators.MaxValueValidator(2023, message='Значение в поле не должно превышать текущий год.')], verbose_name='год выпуска')),
